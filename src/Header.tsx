    ...
    <header className="border-b border-border bg-background">
      <div className="relative mx-auto flex max-w-7xl items-center gap-3 px-6 py-4">
        ...
        {githubUrl ? (
          <a
            href={githubUrl}
            className="hidden shrink-0 items-center gap-2 rounded-full bg-primary px-4 py-1.5 text-sm text-primary-foreground transition-opacity hover:opacity-90 sm:flex"
          >
